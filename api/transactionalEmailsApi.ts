...
export class TransactionalEmailsApi {
     ...
     * @param sendEmail 
     */
    public async sendTemplate (templateId: number, sendEmail: SendEmail, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SendTemplateEmail;  }> {
     ...
     */
    public async smtpLogMessageIdDelete (messageId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
